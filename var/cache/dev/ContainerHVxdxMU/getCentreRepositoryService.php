 ...
 */
class getCentreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CentreRepository' shared autowired service.
     *
     * @return \App\Repository\CentreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CentreRepository.php';

        return $container->privates['App\\Repository\\CentreRepository'] = new \App\Repository\CentreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
