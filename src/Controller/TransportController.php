...
class TransportController extends AbstractController
{
    ...
    #[Route('/front', name: 'app_transport_front', methods: ['GET'])]
    public function front(TransportRepository $transportRepository): Response
    {
        return $this->render('transport/basefront.html.twig', [
            'transports' => $transportRepository->findAll(),
        ]);
    }
    ...
    #[Route('/{num_t}', name: 'app_transport_show', methods: ['GET'])]
    ...
    #[Route('/{num_t}/edit', name: 'app_transport_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{num_t}', name: 'app_transport_delete', methods: ['POST'])]
